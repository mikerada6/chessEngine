...
public class BoardTest extends TestCase {
    ...
    public void testNewBoard() {
        ...
        assertEquals(65535L, b.getWhiteBitBoard());
        ...
        assertEquals(-281474976710656L, b.getBlackBitBoard());

        assertEquals(-281474976645121L, b.getOccupiedBitBoard());

        assertEquals(281474976645120L, b.getEmptyBitBoard());
    ...
    public void testNewFen1String() {
        ...
        assertEquals("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1", b.getFEN());
    }

    public void testNewFen2String() {
        ...
        assertEquals("8/8/8/8/8/8/1k6/R3K3 w Q - 0 1", b.getFEN());
    }
    ...
    public void testMove1() {
        ...
        assertEquals(16842240L, b.getWhitePawnBitBoard());
        assertEquals(129L, b.getWhiteRookBitBoard());
        assertEquals(66L, b.getWhiteKnightBitBoard());
        assertEquals(36L, b.getWhiteBishopBitBoard());
        assertEquals(8L, b.getWhiteQueenBitBoard());
        ...
        assertEquals(WHITE_PAWN, b.pieceAtSquare(24));
        assertEquals(WHITE_PAWN, b.pieceAtSquare(9));
        assertEquals(WHITE_PAWN, b.pieceAtSquare(10));
        assertEquals(WHITE_PAWN, b.pieceAtSquare(11));
        assertEquals(WHITE_PAWN, b.pieceAtSquare(12));
        ...
        for (int i = 16; i < 48; i++) {
            if (i == 24) {
                ...
                assertEquals(EMPTY, b.pieceAtSquare(8));
            } else {
                assertEquals(EMPTY, b.pieceAtSquare(i));
            }
        }
